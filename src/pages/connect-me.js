    ...
    return (
        ...
        <div className="pt-2r">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 pt-2">
                <div className="flex items-center gap-3 border border-slate-400 cursor-pointer" onClick={() => redirect(socials.stackblitz)}>
                    <Stackblitz />
                    <div className="text-2r">Stackblitz</div>
                </div>
               <div className="flex items-center gap-3 border border-slate-400 p-4 cursor-pointer">
               ...
               <div className="flex items-center gap-3 border border-slate-400 p-4 cursor-pointer">
                        <svg onClick={() => redirect(socials.medium)} xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-medium" viewBox="0 0 16 16">
                            <path d="M9.025 8c0 2.485-2.02 4.5-4.513 4.5A4.506 4.506 0 0 1 0 8c0-2.486 2.02-4.5 4.512-4.5A4.506 4.506 0 0 1 9.025 8m4.95 0c0 2.34-1.01 4.236-2.256 4.236S9.463 10.339 9.463 8c0-2.34 1.01-4.236 2.256-4.236S13.975 5.661 13.975 8M16 8c0 2.096-.355 3.795-.794 3.795-.438 0-.793-1.7-.793-3.795 0-2.096.355-3.795.794-3.795.438 0 .793 1.699.793 3.795"/>
                        </svg>
                        <div className="text-2r">Medium</div>
               </div>
               <div className="flex items-center gap-3 border border-slate-400 p-4 cursor-pointer">
                    <svg onClick={ () => redirect(socials.instagram)} xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
                    ...
                    <div className="text-2r">Instagram</div>
                </div>
                <div className="flex items-center gap-3 border border-slate-400 p-4 cursor-pointer">
                    <svg onClick={() =>redirect(socials.linkedin)}  xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-linkedin" viewBox="0 0 16 16">
                        <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854zm4.943 12.248V6.169H2.542v7.225zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248S2.4 3.226 2.4 3.934c0 .694.521 1.248 1.327 1.248zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016l.016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225z"/>
                    </svg>
                    <div className="text-2r">Linkedin</div>
                </div>
                
                {/* <svg onClick={() =>redirect(socials.linkedin)} xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-whatsapp" viewBox="0 0 16 16">
